...
from model import NetworkNvidia, LeNet
...
def parse_args(dataPath):
    ...
    # be careful with num_workers=8, try set it to smaller numbers (even 0) if memory runs up
